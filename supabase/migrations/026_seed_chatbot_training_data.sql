-- Sample Training Data for MotoRent Chatbot
-- This file contains 30+ example Q&A pairs to train the chatbot
-- Import this to seed initial training data

INSERT INTO chatbot_training_data (question, answer, intent, category, confidence) VALUES

-- PRICING & COSTS (Category: pricing)
...
-- CANCELLATION & POLICIES (Category: policies)
...
-- BOOKING & AVAILABILITY (Category: booking)
...
-- REQUIREMENTS & AGE (Category: requirements)
...
-- INSURANCE & SAFETY (Category: insurance)
...
-- FUEL & MAINTENANCE (Category: fuel_policy)
...
-- DOCUMENT STATUS (Category: documents)
...
-- PAYMENT & TRANSACTIONS (Category: payment)
...
-- CONTACT & SUPPORT (Category: support)
...
-- BIKE RECOMMENDATIONS (Category: recommendations)
...
-- SPECIAL SITUATIONS (Category: special)
...
-- Add timestamps
UPDATE chatbot_training_data SET updated_at = NOW() WHERE updated_at IS NULL;
